...
const commandData = [
  ...
  },
  {
    title: "Pet Battles",
    usage: "/petbattles",
    description: "Engage with pet battles, earn XP and become top of the leaderboard!",
    category: "games",
    icon: "🐾",
  },
  {
  ...
  },
  {
    ...
    usage: "/league",
    description: "Check your League Stats, Live Game Details! & Champion Mastery!",
    category: "gaming",
    icon: "🏅",
  },
  {
          ...
          >
            ...
            <div className="pl-2 border-l-2 border-purple-500/50 ml-5">
              <p className="text-gray-300 mb-2 font-mono text-sm">
                <span className="text-indigo-400 font-semibold">Usage:</span> {command.usage}
              </p>
    ...
    content: (
      <div className="flex items-center justify-center h-64 bg-gradient-to-r from-purple-900/20 to-indigo-900/20 rounded-xl border border-purple-500/20 backdrop-blur-sm">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-purple-400 mb-2">New Commands Under Development</h3>
          <p className="text-gray-300 max-w-md mx-auto">
            Our team is working on exciting new features. Stay tuned for updates!
          </p>
        </div>
      </div>
    ),
...
const featureData = [
  {
    ...
    description: "Stay ahead of the cosmic curve with personalized horoscopes tailored to your zodiac sign.",
    icon: "✨",
  },
  {
    title: "Apex Legends Stats",
    description: "Track your progress from kill counts and wins to character-specific data.",
    icon: "🎮",
  },
  {
    title: "League of Legends Stats",
    description: "Monitor win rates, KDA ratios, champion mastery, and more to level up your game.",
    icon: "🏆",
  },
  {
    title: "Fortnite Stats",
    description: "Track match history, survival rate, and elimination stats to dominate the island.",
    icon: "🔫",
  },
];
      ...
      <section className="text-white relative">
        ...
        <div className="col-span-7 text-left flex flex-col h-full">
          ...
          <div className="bg-gray-900/30 p-4 rounded-lg backdrop-blur-sm border border-gray-700/50">
            {tab_data.find((t) => t.id === tab)?.content || "Tab content not found"}
          </div>
        </div>
      </div>
    </section>
