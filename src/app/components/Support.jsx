	...
	return (
		<div className="w-full my-10">
			...
			<div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 py-16 mb-12 rounded-xl">
				...
				<div className="relative z-10 text-center px-6">
					...
					<p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
						Need assistance? Report bugs, request features, or get help with AstroStats.
					</p>
					<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
						<button
							onClick={() => openExternalForm(bugReportUrl)}
							className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg group"
						>
						...
						<button
							...
							className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg group"
						>
							<svg className="w-5 h-5 mr-2 group-hover:animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
				{/* Bug Report Card */}
				<div 
					className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 hover:border-red-500 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl group cursor-pointer"
					onClick={() => openExternalForm(bugReportUrl)}
				>
					...
					<p className="text-gray-300 mb-4 leading-relaxed">
						Encountered an issue? Let us know about bugs, errors, or unexpected behavior in AstroStats.
					</p>
				...
				<div 
					className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 hover:border-green-500 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl group cursor-pointer"
					onClick={() => openExternalForm(featureRequestUrl)}
				>
					<div className="flex items-center mb-4">
					...
					<p className="text-gray-300 mb-4 leading-relaxed">
						Have a great idea? Share your suggestions to help improve AstroStats.
					</p>
				...
				<div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl group">
					...
					<p className="text-gray-300 mb-4 leading-relaxed">
						Need help with AstroStats? Ask questions or get assistance.
					</p>
