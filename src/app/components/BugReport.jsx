...
const BugReport = () => {
    useEffect(() => {
        if (typeof document !== "undefined") {
            document.title = "AstroStats • Report a Bug";
        }
    }, []);
            ...
            <section className="relative mx-auto max-w-5xl px-4">
                ...
                <header className="text-center mb-12">
                    ...
                    <p className="mt-4 text-lg text-[#adb7be] max-w-2xl mx-auto">
                        Found an issue with AstroStats? Let us know using the form below
                    </p>
                            ...
                            <form onSubmit={onSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-xs text-white/40">
                                        ...
                                        <span className="text-white/70">Bug</span>.
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <CustomSelect
                                            ...
                                            onChange={setProject}
                                            options={[
                                                { value: "web", label: "AstroStats Web" },
                                                { value: "bot", label: "AstroStats Bot" }
                                            ]}
                                            colorScheme="indigo"
                                        />
                                    </div>
